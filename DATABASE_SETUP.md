# Database Setup Guide - PrimeFx Invest

## Problem: Database Tables Not Created

Your Supabase project is connected but the database tables haven't been created yet. Here's how to fix it:
...
2. Select your project: **evjoyubypgjutylekiys**
3. Click on the **SQL Editor** (left sidebar)

### Step 2: Create New Query

1. Click the **"New Query"** button (+ icon)
2. Or click **"New SQL query"**
...
2. Wait for the query to complete (you should see "Success" message)
3. You'll see: "Ran 1 statement" or similar
...
Refresh your browser and try to sign up. The database should now work!
...
- Tables weren't created. Make sure you ran the SQL above.

**"Error: Permission denied"**
- Check your RLS policies. Run the SQL policies section above.

**"Error: Duplicate key value"**
- Some tables may already exist. Use `IF NOT EXISTS` (which is already in the script).

## Next: Enable Email Authentication
