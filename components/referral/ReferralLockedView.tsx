...
import { CircleDollarSign, Lock, Share2, Sparkles } from 'lucide-react'
          ...
          <div>
            ...
            <ul className="mt-5 space-y-2 text-sm text-gray-700">
              <li className="flex items-center gap-2">
                <CircleDollarSign className="h-4 w-4 text-[#0052ff]" />
                {formatReferralRate(REFERRAL_INVESTMENT_COMMISSION_RATE)} commission on referred deposits
              </li>
              <li className="flex items-center gap-2">
